			...
			<div class="container">
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<!-- Cart -->
						<li class="header-cart dropdown center-dropdown">
							...
							<div class="custom-menu fluid">
								<div id="shopping-cart">
									...
									<div class="shopping-cart-btns">
										<a class="text-uppercase main-btn" href="keranjang.php">Keranjang</a>
										<a class="text-uppercase primary-btn" href="checkout.php">Checkout <i class="fa fa-arrow-circle-right"></i></a>
									</div>
								</div>
							</div>
						</li>
			...
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						...
						<li><a href="customer.php">Profil</a></li>
					</ul>
				</div>
				<!-- menu nav -->
			</div>
